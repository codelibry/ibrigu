...
?>
<?php if ($dropdownList) : ?>
    <?php $items = count($dropdownList); ?>
    <section
            class="dropdown-block <?php echo 'pt-' . $paddingTop_mobile . ' pb-' . $paddingBottom_mobile . ' pt-md-' . $paddingTop . ' pb-md-' . $paddingBottom; ?><?php if($items == 1){ echo ' single-item'; } ?>">
        <div class="container" style="background-color: <?php echo $backgroundColor; ?>">
            <div class="dropdown-block__wrap dropdown--desk">
                <ul class="dropdown-block__list">
                    <?php foreach ($dropdownList as $idx => $dropdown) : ?>
                        <?php if ($idx % 2 == 0) : ?>
                            <?php
            ...
            <div class="dropdown-block__wrap dropdown--mobile">
                <ul class="dropdown-block__list">
